...
from src.models.components.blocks import MobileOneBlock, ReparamLargeKernelConv
...
class RepMixer(nn.Module):
    ...
    def reparameterize(self) -> None:
        """Reparameterize mixer and norm into a single convolutional layer for efficient
        inference."""
...
class RepCPE(nn.Module):
    ...
    def __init__(
        ...
        assert len(spatial_shape) == 2, (
            f'Length of "spatial_shape" should be 2, ' f"got {len(spatial_shape)} instead."
        )
...
class FastViT(nn.Module):
    ...
    def init_weights(self, pretrained: str = None) -> None:
        ...
        for mmdetection or mmsegmentation by loading ImageNet pre-trained weights.
        """
